BOT_PATH = bot_src/#путь до папки с ботом
...
build: CFiles_OBG
	g++ $(DB_FILES_TO_COMP) $(BOT_PATH)telegram_bot.cpp  -o telegram_bot --std=c++14 -I/usr/local/include -lTgBot -lboost_system -lssl -lcrypto -lpthread -lcurl -ldl 
